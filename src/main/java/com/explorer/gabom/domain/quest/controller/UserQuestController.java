...
import com.explorer.gabom.domain.quest.service.QuestProgressService;
...
public class UserQuestController {
	...
	public ResponseEntity<ApiResponse<QuestRewardResponse>> claimReward(
		...
		QuestRewardResponse response = questProgressService.claimReward(userDetails.getUserId(), userQuestId);
